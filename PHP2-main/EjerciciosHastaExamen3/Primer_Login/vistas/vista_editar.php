...
?>
    ...
    <form action="index.php" method="post">
        ...
        <p>
            Tipo:
            <input type="radio" name="tipo" id="admin" value="admin" <?php if ($tipo=="admin") echo "checked"; ?> >
            <label for="admin"> Administrador </label>
            <input type="radio" name="tipo" id="normal" value="normal" <?php if ($tipo=="normal") echo "checked"; ?> >
